                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive" id="institue">
                        <form action="" class="es-form es-add-form">
                            ...
                            <!---- slide show table  ----->
                            <table id="dfdsds" class="table table-bordered mt-3 text-center">
                                ...
                                <tbody>
                                    ...
                                    <tr id="tr_{{$value->id}}">
                                        ...
                                        <td>{{$value->status}}</td>
                                        <td>
                                            <a href="{{route('career.view', $value->id)}}"><i class="fa-solid fa-eye"></i></a>&nbsp &nbsp
                                            <a href="{{route('career.edit', $value->id)}}"><i class="fa-solid fa-pencil"></i></a>&nbsp &nbsp
